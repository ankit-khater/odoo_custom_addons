...
class ReportSalesSalespersonWise(models.AbstractModel):
    _name = 'report.sales_report_by_saleperson.sale_productcate_consultant'
                 ...
                 for p in data2:
                    ...
                    for k in data3:
                        ...
                        user = self.env['account.invoice'].search(
                            [('id', '=', k.invoice_id.id), ('consultant_refer', '=', id), ('origin', '=', k.origin),
                        ...
                        user_flag = False
                        for u in user:
                            if u.consultant_refer.id==id:
                                user_flag=True
                                print user_flag
                                print "consultant :",u.consultant_refer.id
            ...
            for i in data:
                ...
                for j in data1:
                 ...
                 for p in data2:
                    ...
                    for k in data3:
                        print "Invoice_Id:", k.invoice_id.id
                        user = self.env['account.invoice'].search([('id', '=', k.invoice_id.id), ('consultant_refer', '=', id),('origin','=',k.origin),('create_date', '>=', start_date),
                         ('create_date', '<=', end_date),('state','=','paid')])
    ...
    def render_html(self, docids, data=None):
        ...
        report = report_obj._get_report_from_name('sales_report_by_saleperson.sale_productcate_consultant')
        print report
        ...
        return self.env['report'].render('sales_report_by_saleperson.sale_productcate_consultant', docargs)
